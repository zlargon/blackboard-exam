	...
	tinymce.create('tinymce.ui.KeyboardNavigation', {
      ...
      var index = 0;
			...
			each(items, function(item, idx) {
				...
				{
console.log( "tiny_mce_src.js, excludeFromTabOrder='true' called, setting tabindex='-1' for elm.id=" + elm.id  + " AND setting a javascript variable called 'tabindex' to -1 " );				  
...
tinymce.create('tinymce.ui.Separator:tinymce.ui.Control', {
	...
	renderHTML : function() { 
		return tinymce.DOM.createHTML('span', {'class' : this.classPrefix, role : 'separator', 'aria-orientation' : 'vertical', 'tabindex' : '-1'});    // Tom, why is tabindex a variable here? (I changed 'tabindex' from being a variable to a constant. 
	}
});
(function(tinymce) {
...
(function(tinymce) {
	...
	tinymce.create('tinymce.ui.SplitButton:tinymce.ui.MenuButton', {
		...
		renderHTML : function() 
		{
			...
			if( t.id == 'feedbacktext_spellchecker' || t.id == 'descriptiontext_spellchecker' )
			{  
			  h1 += DOM.createHTML('span', {'class': 'mceVoiceLabel mceIconOnly', id: t.id + '_voice', style: 'display:none;'}, s.title);
			  h += '<td >' + DOM.createHTML('a', {role: 'button', id : t.id + '_action', tabindex: '0', href : 'javascript:;', 'class' : 'mceAction ' + s['class'], onclick : "return false;", onmousedown : 'return false;', title : s.title}, h1) + '</td>';  
			}
			else
			{
			  h1 += DOM.createHTML('span', {'class': 'mceVoiceLabel mceIconOnly', id: t.id + '_voice', style: 'display:none;'}, s.title);
	...
	tinymce.create('tinymce.Editor', {
      ...
      //BB code end
        ...
        //BB Code end
			...
			t.iframeHTML = s.doctype + '<html class="mceContentHtml"><head xmlns="http://www.w3.org/1999/xhtml">';
        ...
        //BB Code Begin -- Added it for the removing the html for the simple VTBE
      {
		...
		getContent : function(args) {
			...
			if (!args.no_events) {
				if (args.source_view) {
					self.execCommand('clearSpellCheckMarkUp');
				}
	...
	tinymce.EditorCommands = function(editor) {
		...
		addCommands({
			...
			'Cut,Copy,Paste' : function(command) {
			  // BB Code begin - Fix LRN-109697 issue
				var doc = editor.getDoc(), failed, cmdExecResult;

				// Try executing the native command
				try {
					cmdExecResult = execNativeCommand(command);
				} catch (ex) {
					// Command failed
					failed = TRUE;
				}
				...
				if ((!cmdExecResult && !tinymce.isIE11) || failed || !doc.queryCommandSupported(command)) {
				// BB Code End
