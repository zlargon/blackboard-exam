...
//sessionkey
var var_key = "5848a0c9-b1af-4d5a-8c90-17ff805b484b";
...
var var_stamp = "20180630175017";
var var_eesy_build = "3939";
var var_eesy_dbUpdateCount = "448";
  ...
  function __eesyRequire(sessionKey, build, dbUpdateCount) {
    return eesy.requirejs.config({
      ...
      paths: {
        ...
        'expert-context-definer':
          'static/js/expert-context-definer',
          
         'expert-tools':
            'static/js/expert-tools',
        ...
        'language-cms':
          'rest/language/cms?sessionkey=' + sessionKey,
        ...
        'user-context-variables':
          'rest/proactive/userContextVariables?v=' + build + "&u=" + dbUpdateCount + '&sessionkey=' + sessionKey + '&courseId=' + window.eesy_course_id,
