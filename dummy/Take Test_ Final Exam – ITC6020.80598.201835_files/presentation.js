eesy.define([
    ...
    function($, sessionInfo,
        engineState, utils, helpitemLoader, contextlinks, mouse, settings, Mustache, expertTools) {
  ...
  */
  ...
  function showDashboardLinker(p) {
    ...
    if ( $('.patient-bar-container__content').length ) {
  		...
  		function scrollAdjust() {
  		  var adjustScrollbarZd = false;


  			adjustScrollbarZd = adjustScrollbarZd ||
    ...
    if (var_moveable_tab === true) {
      if (supportTabPosition !== null) {
          ...
          if (! $('#eesy-tab-inner').isInViewport()) {
  ...
  return {
    ...
    hideHint: hideHint,
    isHint: isHint,
    showExpertTools: showExpertTools
  };
});
